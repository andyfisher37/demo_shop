...
class _AuthCardState extends State<AuthCard>
  ...
  // Map for storage authorization data
  ...
  // Text cotroller for password form
  final _passwordController = TextEditingController();
  // Animation controller for login form
  late AnimationController _controller;
  // Slide animation for texts
  late Animation<Offset> _slideAnimation;
  // Opacity animation for butons
  late Animation<double> _opAnimation;
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: AnimatedContainer(
        ...
        //BoxConstraints(minHeight: _hAnimation.value.height),
